...
def main():
    ...
    ap.add_argument("--out_preds", default=str(REPO_ROOT / "artifacts/gtsrb_preds_qlora.jsonl"))
    ap.add_argument("--base_model", default="Qwen/Qwen3-VL-2B-Instruct")
    ap.add_argument("--adapter_dir", default=str(REPO_ROOT / "artifacts/gtsrb_qwen3vl_qlora"))
